...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'trader', 'analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Analyst', path: '/analysts', entity: 'analyst', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
    {
      name: 'Customer',
      path: '/customers',
      entity: 'customer',
    ...
    { name: 'Trader', path: '/traders', entity: 'trader', service: AccessServiceEnum.PROJECT, icon: FiTrendingUp },
