      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl id="trading_order" mb="4" isInvalid={!!formik.errors?.trading_order}>
              <FormLabel>Trading Order</FormLabel>
              <Input
                type="text"
                name="trading_order"
                value={formik.values?.trading_order}
                onChange={formik.handleChange}
              />
              {formik.errors.trading_order && <FormErrorMessage>{formik.errors?.trading_order}</FormErrorMessage>}
            </FormControl>
